package net.redlinesoft.app.harlemshake;
...
import net.redlinesoft.app.harlemshake.R;
...
public class MainActivity extends Activity {
	...
	String url = "http://query.yahooapis.com/v1/public/yql?q=select%20title%2Clink%20from%20feed%20where%20url%3D%22https%3A%2F%2Fgdata.youtube.com%2Ffeeds%2Fapi%2Fplaylists%2F1_8_k0Qgcd1-tuQOFQVwUZMnNV_lBROa%3Fv%3D2%26max-results%3D50%22%20and%20link.rel%3D%22alternate%22&format=json&callback=";
	...
	public void onCreate(Bundle savedInstanceState) { 
		...
		if (checkNetworkStatus()) {	 
			// Create the adView
			adView = new AdView(this, AdSize.BANNER, "a15121cd60b0d8b");
